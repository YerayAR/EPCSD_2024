...
* A folder for the <a href="https://github.com/ppinedar/epcsd-spring-2023-productcatalog-improved">ProductCatalog</a> microservice
* A folder for the <a href="https://github.com/ppinedar/epcsd-spring-2023-user-improved">User</a> microservice
* A folder for the <a href="https://github.com/ppinedar/epcsd-spring-2023-notification-improved">Notification</a> microservice
